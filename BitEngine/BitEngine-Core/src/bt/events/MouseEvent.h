...
namespace bt { namespace events {
	...
	class BT_API MouseButtonEvent : public Event
	{
	protected:
		int32 m_Button;
	...
	class BT_API MousePressedEvent : public MouseButtonEvent {
	public:
	...
	class BT_API MouseReleasedEvent : public MouseButtonEvent {
	public:
	...
	class BT_API MouseMovedEvent : public Event {
	private:
		maths::vec2 m_Position;
		bool m_Dragged;
	public:

...
If you are not comming from [GettingStarted](GettingStarted.md) i advise you to go there and follow the steps there before you start with this one. We are going to use everything from there to begin this tutorial so that i dont have to go
thrue all the getting started things again

Okay we can start by creat the playing field
